...
public class Generator {
    public void generateKafkaEvents() {
        ...
        ArrayList<User> userBase = userBaseService.generateUserBase(20); //w parametrze podajesz ilu chcesz użytkowników w generowanej bazie
        ArrayList<Message> messageBase = messagesBaseService.generateMessageBase(100, userBase); //ile ma zrobić wiadomości

       new CompletableFuture().runAsync(() -> kafkaProducer.produceUser(userBase));
