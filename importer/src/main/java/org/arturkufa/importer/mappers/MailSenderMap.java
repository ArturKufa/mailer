...
public  class MailSenderMap extends RichCoFlatMapFunction<User, Mail, Tuple2<User, Mail>> {
    // keyed, managed state
    ...
    public void open(Configuration config) {
        ...
        mailState = getRuntimeContext().getState(new ValueStateDescriptor<>("saved mail by sender", Mail.class));
    }
